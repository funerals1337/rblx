    ...
    do
        function cheat_client:render_on_player(player)
            local esp = setmetatable({
                player = player,
                renders = {
                    name = cheat_client:handle_render("Text", {ZIndex = 2, Text = player.Name, Visible = false, Size = 13, Center = true, Color = newrgb(255, 255, 255), Outline = true, OutlineColor = newrgb(0, 0, 0), Font = Drawing.Fonts.Plex, Transparency = 0.8}),
                    weapon = cheat_client:handle_render("Text", {Visible = false, Size = 13, Center = true, Color = newrgb(255, 255, 255), Outline = true, OutlineColor = newrgb(0, 0, 0), Font = Drawing.Fonts.Plex, Transparency = 0.8}),
                    status = cheat_client:handle_render("Text", {Visible = false, Size = 13, Color = newrgb(255, 255, 255), Outline = true, OutlineColor = newrgb(0, 0, 0), Font = Drawing.Fonts.Plex, Transparency = 0.8}),
                    box = cheat_client:handle_render("Square", {ZIndex = 2, Thickness = 1, Visible = false, Filled = false, Color = newrgb(127, 72, 163), Transparency = 0.8}),
                    box_outline = cheat_client:handle_render("Square", {Thickness = 3, Visible = false, Filled = false, Color = newrgb(0, 0, 0), Transparency = 0.8}),
